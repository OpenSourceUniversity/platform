...
class Course extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchCourse(`http://localhost:8000/api/v1/courses/${this.props.id}/`);
          ...
          <Grid.Column width={11}>
            <Segment style={{ padding: '40px' }}>
              ...
              <Grid>
                <Grid.Row>
                  <Grid.Column width={4}>
                    <Button as="a" target="_blank" href={this.props.course.link}>SHOW COURSE</Button>
                  </Grid.Column>
                  <Grid.Column width={6}>
              ...
              <Container style={{ paddingLeft: '40px', paddingRight: '40px' }}>
                {(() => {
                  ...
                  default: return this.props.course.about;
                  }
                })()}
              </Container>
            </Segment>
          ...
          <Grid.Column width={5}>
            <Segment style={{ padding: '40px' }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <Label
                  as="a"
                  href=""//{!this.props.course.link ? '#' : (this.props.course.link.split('/')[0] + this.props.course.link.split('/')[2]).toString()}
                  target="_blank"
                  circular
                  style={{
                    boxShadow: '2px 6px 20px 0 #bcbdbd, 0 1px 21px 1px #d4d4d5', width: '8em', height: '8em', backgroundColor: 'white', backgroundImage: `url(${this.setIcon(this.props.course.provider)})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: '80%',
                  }}
                />
                <Header>
