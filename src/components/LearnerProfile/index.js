              ...
              <Segment.Group className="profileSegment">
                <Segment textAlign="center">
                  <Segment
                    ...
                    style={{
                      width: 175, height: 175, backgroundImage: `url(${this.props.accounts.lerner_avatar ? this.props.accounts.lerner_avatar : avatarPlaceholder})`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'center center',
                    }}
                  />
                  <Header size="large">
